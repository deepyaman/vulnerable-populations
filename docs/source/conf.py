...
# vulnerable_populations documentation build
...
from vulnerable_populations import __version__ as release

# -- Project information -----------------------------------------------------

project = "vulnerable_populations"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "vulnerable_populationsdoc"
...
latex_documents = [
    (
        master_doc,
        "vulnerable_populations.tex",
        "vulnerable_populations Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "vulnerable_populations",
        "Project vulnerable_populations codebase.",
        "Data-Science",
    )
]
